# employee-crud Specification

## Purpose
Defines the full CRUD surface for Employee records — create, profile view, list/search, edit, and archive. This spec covers the API endpoints, DTOs, and the Angular frontend feature. The entity model and lookup API are in the employee spec.
